import React, { useRef, memo, Ref, RefObject } from "react";
...
interface WindowProps {
  app?: {
    ...
    ParentRef: any;
    component?: any | React.FC<{ callback: any }> | JSX.Element;
  };
  onMouseDown?: any;
  onClose?: any;
  onMinimize?: any;
...
const Windows: React.FC<WindowProps> = function ({
  app,
  onMouseDown,
  onClose,
  onMinimize,
...
interface Props {
  ...
  onMouseDown?: any;
  onMouseUpClose?: any;
  onMouseUpMinimize?: any;
  onMouseUpMaximize?: any;
  header?: any;
  defaultSize?: any;
  defaultOffset?: any;
  resizable?: any;
...
const Window: React.FC<Props> = memo(function ({
  injectProps,
  id,
  onMouseDown,
  onMouseUpClose,
